...
#define BUTTON_HOVER_COLOR sf::Color(220,220,220)
...
#define MENU_COLOR sf::Color(0, 120, 0)
...
#define APP_OUTPUT_COLOR sf::Color(0, 120, 0)
...
#define APP_OUTPUT_RUN_CODE "BUILD AND RUN"
...
#define ADD_BLOCK_MENU_COLOR sf::Color(0, 120, 0)
...
#define APP_MENU_COLOR sf::Color(0, 120, 0)
...
#define USER_INPUT_BACKGROUND_COLOR sf::Color(169, 169, 169)
#define USER_INPUT_BACKGROUND_BORDER_COLOR sf::Color(0, 120, 0)
